...
Equivalently we define a negative output gap as a situation where $\dot{y}<\dot{y}^{*}$. This is the equivalent of saying that you are generating a lot more savings that you are consuming every year thus creating deflationary pressures. Japan is the archetype example of this situation.
...
Do you understand now? The value of understanding how the world works. This is a tiny sliver of the amount of knowledge that is out there. This is not even the surface of economics if you would one day want to truly understand it. Yet, I have altered the world you live in if you take the time, and truly understand the math in here. It is so intuitive. You will never need to rely solely on statistics, if you understand it. Your eyes and your knowledge of economics will be enough for you to always know, how any country is doing. Do you finally understand why the entire world, sooner or later, can only head in a spree of revolutions, as the true positions of all economies come up to surface? Only the United States is currently safe from a revolution. Unless, it recklessly puts itself in that position by taking too much debt. Do you understand now, why even though I wish, it did not need to come to that. We might very well, have have no choice. 