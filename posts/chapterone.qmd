...
So, this spike of inequality in Mauritius right now was caused by none other than the Government of the Republic of Mauritius itself. They knew GDP was fake, given they compiled it that way to be able to borrow more. So, this is a huge problem. Respecting debt limits and knowing what limit is appropriate is a key thing to look at carefully in the future because it is the biggest way to decrease inequality intertemporally for every Mauritian that will ever live. One simple solution is to use absolute limits like the United-States does so as to make faking statistics useless, in manipulating the state's ability to take more debt that it can muster at any given time. One thing to avoid, is also to not increase the absolute limit every 3-4 years like the US does which makes it useless. Do you understand now? The value of understanding how the world works.