...
I should not have to convince you that gravity exists. If you drop something, you can observe that it will fall down according to the [laws of classical mechanics](https://en.wikipedia.org/wiki/Newton%27s_laws_of_motion). Just like physics, economics is a deterministic field of study. It has its laws too. It is just not explicitly taught that way because it is a social science. I am going to teach you a simple way to think about macroeconomics in this paper that will help you
understand not only the economy of the Republic of Mauritius but any economy in the world. It is slightly hard, if you do not know calculus. That does not mean, you should just give up. Hit a friend up. Tell them to teach you. Do not be ashamed of not understanding this. This is not easy to understand. I am doing what no politician has ever done with you, treat you with respect. You the young people, who understand this, I need you to do your part too. Explain what is in this paper, to people around you who cannot understand it. You need to embrace that, I cannot do everything. You have a very important part to play in all of this if you are educated enough. If you want a country where you could easily be the richest because you know inside you, that you have what it takes. If you want to be the president one day. You have to play your part now to make it possible for you and your own kids tomorrow.

If you understand this paper, you will finally understand that all the economic statistics of the Republic of Mauritius are wildly fake these days. We are on the brink of total collapse more than ever. All it takes, is capital flight from GBC deposits. Even something as small as, one-two billion dollar worth of deposits being claimed would force banks to buy a lot foreign currency breaking the exchange rate, to honor their liabilities. In some cases, some would be forced to sell assets by marking them to market, in the process hurting their books and in all likelihood breaking the banking system as a whole which is not solid at all. You see, these days, Mauritius is just bankrupt. It has been for a long time. But that is the problem with invented governments that has a monopoly over their own currency. They cannot go bankrupt or declare bankruptcy. Because government can always invent an excuse and print money via the central bank. Around 150 billion rupees has been printed solely via bullshit excuses to make up for the fact that the country is broke. Had they not printed that money, a revolution would have already ensued. But they made the situation so much worse, by printing so much money, allowing so much inflation just to save their necks. You have to understand that. You had to pay a price. You had to starve, so they could live another day. Just so they may continue to steal, just so they could keep a noose tied around your necks. Just so they could keep you enslaved. That is not a bad dream I am inventing. That is reality of the situation. Foreign currency access today is only allowed to those who are in the good favors of government. It is the most discriminatory the country has ever been since its independence. There are two kinds of people today in the Republic of Mauritius. The kind who gets unlimited access to foreign currency and the kind that has to beg, to be able to send their children money. The worst of it is that faced with this a lot of conglomerates have simply, stopped selling their foreign currencies. Honestly, I cannot blame them. I would not either. I would use swaps too. Its just a good business decision. If you let go of your FCY, you would be a sitting duck as a business. You need to be liquid enough and government is not. You let go, of your FCY, its gone forever.

Now, this discrimination was always true of domestic currency and still is. There are people in the Republic of Mauritius that always had unlimited access to money and generally at a reduced cost. You can use any word you want but crony is a good word. A crony can be anybody, so we should define the term. A crony is anybody who gets gets their cost of capital subsidised by the government, sometimes below the risk free rate. Now there is a peculiarity with crimes, in that most of them are not recognized as crimes and you cannot do anything about that. I cannot do anything about the free capital that government gave for 56 years. They are not crimes. They are policies, when well orchestrated. Policies that were designed to bleed you as much as possible, to please their cronies and fill their own pockets with any bribe they could get for this favor. Likewise, and it can be cruel to hear this, but politicians never explicitly steal public money. No good politician ever steals public money. Technically they spend public money which will cleverly find its way back to them. Nevertheless among all of these crimes, sometimes are dumbducks who do dumb shit like the empty buildings the government rents, non existent buildings it has paid for in advance, the useless buildings it bought, and the advanced payments it has so frequently given people to get nothing in return. These are examples of public welfare offenses under a fair penal code. You cannot just play with public money as if it is your own god damn money. You must be smart when stealing public money. This current government was not. Well, I guess you do not need to be right now in Mauritius, given laws have become useless. ICAC? More like ICUCK. It is a crazy country we live in. With all the aiding, abetting and obstruction of justice that happens daily. Anyway, all of these are public offenses which are strict liability offenses. So, mens rea will not save anbody. There is no need to worry about the criminals. US law is not the flimsy Mauritian law you have lived with for 56 years. So, if no one told you yet, you need to realise the laws in this country suck. They had to so people could do whatever the fuck they wanted for 56 years with your money. Anyway, to sum up, no country, that treats its citizens, with such discrimination can be doing well. Let us understand all of this with some basic mathematics.
...
\end{equation}
 ...
 Now in macroeconomics, there are two type of statistics. One that is called a real statistic where inflation is stripped off and another one where 
 inflation is not stripped off, that is called a nominal statistic. These two statistics are always related to each other, at all times. The challenge is to
 understand, how they are related objectively, so that even if the Republic of Mauritius was faking all of its statistics (which it is doing, these days), it would ultimately not matter,
 because you would not need to rely on any statistic anymore. You would rather have an understanding of how an economy works. You would never need to read an opinion about the 
 economy every again in this life. You would always know everything about any economy. Now, the first step in doing that is to understand how nominal output and real
 output are related. Consider writing $(1)$ in different real terms.
...
\end{equation}
 ...
 As you can see these equations are related by the fact that, they all represent real output, but we do not work with real output in the real world, because governments need a get out of jail free card through money printing. We work with nominal output, because economics is ultimately a ponzi scheme based on population growth, where you pay back debt with a little growth and with money being less valuable over time, which is a process that is called inflation. Do not panic, this is true, well known and easy to derive. We will much further down. You see, the belief that government exists to protect your interests for example is a naive and dumb interpretation of human nature. It is very hard to believe with all the fluff, that government throws at you. But you have to remember, governments exists because it is the most elegant and non controversial way to hold power over the resources of a country, \textbf{unless you have a strong constitution and strong laws that punish criminal behavior consitently}. All you need is a bad constitution and bad laws for the nightmare to begin. These are both things, the Republic of Mauritius has had for 56 years. Which is why it has never progressed and why most countries do not. You are getting played buddy, there is no democracy, no fairness. Just you, the slave who is too afraid to stand up to the bullies of this country. The real question is do you want this to change? Then you need to force yourself to learn. You need to understand the world as it is. Now, back to business, why is it important to understand how real and nominal output works ?
 
 It is important, because one affects the other. There are causal relationships here. Cause and effect relationships, which means that, $p_{\text{deflator}}$ which here represents either the GDP deflator or 
 the consumer price index (CPI) and $k$ which here represents the exchange rate, can give you useful information about any economy at any time. You do not need to know real output exactly, you can infer everything from a robust understanding of how the exchange rates, price indexes and output are objectively related. Economics is not magic. These are simple rules every economy out there will always respect. Meaning these are three ways to be looking at the same thing objectively, because
 all these three equations represent the same thing $y$ which is real output. So this logically means that $(2)$ is equivalent to (3).

\begin{equation}\tag{3}\label{eq-c}
 \text{Real Output} \Longleftrightarrow \text{Real Output} \Longleftrightarrow  \text{Real Output} 
\end{equation}

So even if, any government like the current republic of mauritius fakes all its statistics, it cannot fake how economics works deterministically. If you can understand that, then you are good to go. The biggest barrier to understanding this is going to be basic calculus. It is unlikely that I would be able to teach you calculus here if you do not know it. This is the point, where you ask a friend to teach you calculus by explaining the things here. Do not be ashamed, to ask. So the first thing we have to do is understand the causal relationships between 

\begin{equation}
\dfrac{dy}{ds}= \dfrac{dy}{dp} \dfrac{dp}{ds} = \dfrac{dy}{dk} \dfrac{dk}{ds} = Productivity

\end{equation}


\begin{equation}
\dfrac{dy}{dc}= \dfrac{dy}{dp} \dfrac{dp}{dc} = \dfrac{dy}{dk} \dfrac{dk}{dc} = Inflation

\end{equation}

So from these two equations, the first causal relationship that we find is that between productivity and inflation. Productivity is the absence of inflation. An increase in inflation will always be met by decreases in productivity. Now why is that true? To understand that we need to understand the causal relation between exchange rates, prices and real output. We can understand that by defining the total differential of both price $p(c(t),s(t))$ and exchange rate $k(c(t),s(t))$ over time to be. 
...
Let us now do examples then and apply this thing, to show how easy it is to estimate the actual inflation that the country has been going through. We can also estimate it this way.
...
y_0 = [0.10508] # start with 10% growth to converge to zero growth
...
The other way to deal with your debt capacity is to take it to the limit. Only advanced economies can do this. You need to be productive enough to do this. You see, if we take capacity of the debt to its limit what would the equation spit out? What is the upper bound? Let's take it to the limit and see by setting $L=1$. 

$$\lim_{i\to 0} L(i) = \frac{L}{i} = \infty $$

So, that's cool right? You can actually hold your own, by hanging on to close to zero growth, by pushing rates down as much as you can. In the real world, you call that using negative interest rates. You reduce interest payments temporarily by doing that. However, it is actually the worst of solutions, given you are allowing yourself to take a lot more debt. Debt is basically borrowing against, not only future hours of work but its rewards too. Claiming it now. Claim too much debt and you make it impossible for the system to continue because it would be the equivalent of slavery. Finesse is needed to find the right balance. The problem with this method is, it needs a lot of conditions for it to be reliable over a long enough period of time. In that time, where all the conditions hold, you will inevitably overreach and take too much debt, because it becomes ''too affordable''. It will be too difficult to resist. If US rates $i^{*}$ rise though, you will get screwed, if raising rates would put you into default. Your exchange rate will thus suffer from $i^{*}-i$ and you will get a surge of inflation. It can still work in some cases. You see, as long as you are creating new real savings, that is as long as there is growth, you should be somewhat fine, increasing real consumption. In zero growth though, you will be screwed, because debt repayments will require you to cut consumption by an equal amount for the derivatives' total change to be zero as can be seen in $(11)$.
...
So, this spike of inequality in Mauritius right now was caused by none other than the Government of the Republic of Mauritius itself^[By not giving a fuck about the debt limit]. They knew GDP was fake, given they compiled it that way to be able to borrow more. So, this is a huge problem. This is what you have been voting for 56 years. The same shit happened in the 1980's did it not? That is a worldwide problem, not exclusive to the Republic of Mauritius. Respecting debt limits and knowing what limit is appropriate is a key thing to look at carefully in the future because it is the biggest way to decrease inequality intertemporally for every Mauritian that will ever live. One simple solution is to use absolute limits like the United-States does so as to make faking statistics useless, in manipulating the state's ability to take more debt that it can muster at any given time. One thing to avoid, is also to not increase the absolute limit every 3-4 years like the US does which makes it useless.

Do you understand now? The value of being well educated. Of understanding how the world works. This is a tiny sliver of the amount of knowledge that is out there. This is not even the surface of economics if you would one day want to truly understand it. Yet, I have altered the world you live in if you take the time, and truly understand the math in here. It is so intuitive. You will never need to rely solely on statistics, if you understand it. Your eyes and your knowledge of economics will be enough for you to always know, how any country is doing. Do you finally understand why the entire world, sooner or later, can only head in a spree of revolutions, as the true positions of all economies come up to surface? Only the United States is currently safe from a revolution. Unless, it recklessly puts itself in that position by taking too much debt. Do you understand now, why even though I wish, it did not need to come to that. We might very well, have have no choice. The world is going to shit.